#!/usr/bin/env python3
"""Build ep03 Remotion Explainer props from the 04-script SSOT.

Episode-specific configuration for ep03-scene-building. The shared engine logic
...
Usage:
    python content-library/ep03-scene-building/07-assembly/build_props.py
"""
...
# Paths
# ---------------------------------------------------------------------------
EP_DIR = REPO_ROOT / "content-library" / "ep03-scene-building"
SCRIPT_MD = EP_DIR / "04-script" / "README.md"
TTS_MANIFEST = EP_DIR / "06-tts" / "assets" / "manifest.json"
OUTPUT_JSON = OPEN_MONTAGE / "remotion-composer" / "public" / "demo-props" / "ep03-shots.json"

# ---------------------------------------------------------------------------
# Avatar configuration (reuse ep02 config)
# ---------------------------------------------------------------------------
AVATAR = {
    "enabled": True,
    "layer": "background",
...
# ---------------------------------------------------------------------------
# Unity background (warp room) — reuse ep02 config
# ---------------------------------------------------------------------------
UNITY_BG_IMAGE = "UnityBG.mp4"
UNITY_BG_QUAD = {
    "tl": [13, 142],
    "tr": [1194, 275],
    "br": [1194, 791],
