...
- 内容策划师：`shared/roles/content/strategist(内容策划师).md`
  - 技术调研与选型对比，按黄金样例风格写 tutorial.final.md（含必讲要点清单）。
  - 只负责"把选题写成观众能懂、能动手的教学软文"，不写分镜口播稿，不改代码。
...
- **冲突裁决口径**（完整层级见根目录 `AGENTS.md`）：Forbidden Actions（`forbidden-actions.md`）> 角色「边界 ❌」> 工作流步骤 > 频道偏好默认值；同层冲突以更具体、更贴近当前产物的规则为准。
