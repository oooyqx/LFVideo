#!/usr/bin/env python3
"""06-tts synthesis for ep03: real narration + lip-sync captions.

Adapted from build_ep02_tts.py with ep03 paths.

Outputs:
  - content-library/ep03-scene-building/06-tts/assets/<shot>.mp3   (per-shot audio)
  - remotion-composer/public/audio/ep03-narration.mp3              (concatenated)
  - content-library/ep03-scene-building/06-tts/assets/manifest.json (timing + captions)

Usage:
    python build_ep03_tts.py                          # edge-tts default voice
    python build_ep03_tts.py --voice zh-CN-YunxiNeural # edge-tts custom voice
    python build_ep03_tts.py --engine doubao           # doubao TTS (reads .env)
"""
...
SCRIPT_MD = REPO_ROOT / "content-library" / "ep03-scene-building" / "04-script" / "README.md"
ASSETS = REPO_ROOT / "content-library" / "ep03-scene-building" / "06-tts" / "assets"
COMPOSER_DIR = Path(__file__).resolve().parent / "remotion-composer"
NARRATION_OUT = COMPOSER_DIR / "public" / "audio" / "ep03-narration.mp3"
NARRATION_REL = "audio/ep03-narration.mp3"
